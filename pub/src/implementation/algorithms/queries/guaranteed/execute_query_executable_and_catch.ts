...
import { Signature } from "../../../../interface/algorithms/queries/guaranteed/execute_query_executable_and_catch"
 ...
 */
export const $$: _easync.Guaranteed_Query_Initializer<d.Parameters, d.Result, null> = (
    $p
) => {
