...
export namespace _T_Copy {
    ...
    export type RESULT = _i_out._T_Copy
}
...
export namespace _T_Make_Directory {
    ...
    export type RESULT = _i_out._T_Make_Directory
}
...
export namespace _T_Read_File {
    ...
    export type RESULT = _i_out._T_Read_File
}
...
export namespace _T_Remove {
    ...
    export type RESULT = _i_out._T_Remove
}
...
export namespace _T_Stat {
    ...
    export type RESULT = _i_out._T_Stat
}
...
export namespace _T_Write_File {
    ...
    export type RESULT = _i_out._T_Write_File
}
